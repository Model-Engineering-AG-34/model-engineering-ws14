...
/**
 * This is the item provider adapter for a {@link forms.AttributePageElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AttributePageElement_attribute_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AttributePageElement_attribute_feature", "_UI_AttributePageElement_type"),
				 FormsPackage.Literals.ATTRIBUTE_PAGE_ELEMENT__ATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
