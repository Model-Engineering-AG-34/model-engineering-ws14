...
/**
 * This is the item provider adapter for a {@link forms.EnumerationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumerationType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumerationType_name_feature", "_UI_EnumerationType_type"),
				 FormsPackage.Literals.ENUMERATION_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormsPackage.Literals.ENUMERATION_TYPE__LITERALS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EnumerationType.class)) {
			case FormsPackage.ENUMERATION_TYPE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case FormsPackage.ENUMERATION_TYPE__LITERALS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormsPackage.Literals.ENUMERATION_TYPE__LITERALS,
				 FormsFactory.eINSTANCE.createEnumerationLiteral()));
	}
