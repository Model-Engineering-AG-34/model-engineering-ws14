...
/**
 * This is the item provider adapter for a {@link forms.RelationshipPageElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RelationshipPageElement_relationship_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RelationshipPageElement_relationship_feature", "_UI_RelationshipPageElement_type"),
				 FormsPackage.Literals.RELATIONSHIP_PAGE_ELEMENT__RELATIONSHIP,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormsPackage.Literals.RELATIONSHIP_PAGE_ELEMENT__EDITING_FORM,
				 true,
				 false,
				 true,
				 null,
