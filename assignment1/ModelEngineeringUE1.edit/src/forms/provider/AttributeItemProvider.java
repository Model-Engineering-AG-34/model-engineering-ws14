...
/**
 * This is the item provider adapter for a {@link forms.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormsPackage.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addMandatoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_mandatory_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_mandatory_feature", "_UI_Attribute_type"),
				 FormsPackage.Literals.ATTRIBUTE__MANDATORY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormsPackage.Literals.ATTRIBUTE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEnumerationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_enumerationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_enumerationType_feature", "_UI_Attribute_type"),
				 FormsPackage.Literals.ATTRIBUTE__ENUMERATION_TYPE,
				 true,
				 false,
				 true,
				 null,
