 ...
 *   <li>{@link forms.impl.FormImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link forms.impl.FormImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link forms.impl.FormImpl#getPages <em>Pages</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FormImpl extends MinimalEObjectImpl.Container implements Form {
	...
	public EList<Page> getPages() {
		if (pages == null) {
			pages = new EObjectContainmentWithInverseEList<Page>(Page.class, this, FormsPackage.FORM__PAGES, FormsPackage.PAGE__FORM);
		}
		return pages;
	}
